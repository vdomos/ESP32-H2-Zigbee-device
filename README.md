...
Testé sur Zigbee2MQTT installé sur Raspberry-Pi 3B avec *coordinator* **PiZigate**

Avec le code <https://github.com/xmow49/ESP32H2-Zigbee-Demo> flashé sur l'**ESP32-H2**, le device apparait dans **Zigbee2MQTT**
